...
- Native invocation evidence: retained in `retained-evidence/description/trial-4-native-trace.jsonl`. Before creating the skill, the agent issued a tool call that read the exact project-local target and received its complete contents. Full native transcript: `retained-evidence/description/trial-4-transcript.jsonl`.
