...
- the generated A-to-B plan, extended tiny application, focused tests, and scenario-created `respectful-archive-labels` skill in the scenario workspace when the agent completes those requested outputs.
