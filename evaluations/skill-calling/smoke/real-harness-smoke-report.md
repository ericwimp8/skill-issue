...
This campaign used only the embedded and custom two-turn smoke inputs. It did not run a governed 30-turn evaluation, automated test suite, implementation audit, or broad validation command. Every evaluated project used a clean temporary Git workspace.
