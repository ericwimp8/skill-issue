...
| `evaluations/skill-calling/scenarios/`                                             | Governed scenario conversations, direct-runner instructions, and separately supplied answer sheets                      | Update when a scenario turn, runner rule, or expected activation changes                                                               |
