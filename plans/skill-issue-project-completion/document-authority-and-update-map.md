...
| `research/harness-subagent-launch/`                                                   | Source-backed delegation capability evidence                                              | Production skills consume it only when they require independent agents; skill-calling replay remains a primary-agent concern                                       |
| `research/deep-research/manual-skill-invocation-nine-harnesses/`                      | Source-backed manual and explicit invocation evidence                                     | Live skill references consume it when invocation controls or user-facing invocation guidance change                                                               |
